...
declare const pongoCollection: <T extends PongoDocument, ConnectorType extends string = string, Payload extends PongoDocument = T>({ db, collectionName, pool, sqlBuilder: SqlFor, schema, errors, }: PongoCollectionOptions<T, ConnectorType, Payload>) => PongoCollection<T>;
